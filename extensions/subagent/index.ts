...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "Subagent",
		description: [
			"Delegate substantial codebase exploration to the scout agent and independent code review to the reviewer agent, each with isolated context.",
		...
		promptSnippet: "Delegate isolated codebase exploration and independent code review to specialized subagents",
		promptGuidelines: [
